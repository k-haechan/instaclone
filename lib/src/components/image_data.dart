...
class ImageData extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Image.asset(icon,
        width: width! /
            Get.mediaQuery
                .devicePixelRatio); //  MediaQuery.of(context).devicePixelRatio 플러터 방식
  }
}

class IconsPath {
  static String get homeOff =>
      'assets/images/bottom_nav_home_off_icon.jpg'; // 리팩토링 1. svg파일로 변경(이미지 색상을 내부적으로 설정할 수 있음)
